...
void netDevLinkTrafficTypeHandle(const char *data);
...
#if defined(CONFIG_ZYXEL_HOME_CYBER_SECURITY_FSECURE) || (defined(CONFIG_ZCFG_BE_MODULE_ZYXEL_FSECURE)&& !defined(ZYXEL_HOME_CYBER_SECURITY_FSECURE_CONTAINER))
...
#if defined (ZYXEL_ECONET_OPERATION_MODE) && defined (YAC_CUSTOMIZATION)
