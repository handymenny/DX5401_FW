...
#define ZY_WIFID_EVT_CHECK_PORT		60007
...
typedef struct wlmodule_s {
	...
	zcfgRet_t (*beWifi_CheckUlIntfConnected)(wlinfo_s *, const char *, bool *, const char *, const char *, int, int);
...
typedef struct wlRetryEvtList_s {
	bool headFlag;
	struct wlRetryEvtList_s *prev;
	struct wlRetryEvtList_s *next;
	char ifName[32];
	void *evt_msg;
	int retry_cnt;
}wlRetryEvtList_t;
