...
#ifdef TT_HGW
#define ZYFWINFO_FIRMWAREVERSION_LEN    32
#else
#define ZYFWINFO_FIRMWAREVERSION_LEN    30
#endif

#ifdef CONFIG_ABZQ_CUSTOMIZATION
// Support Feature of DHCP ACL pool
#define DHCP_ACL_POOL_FILE_NAME	"/var/dnsmasq/acl_pool.conf"

#define DHCP_ACL_POOL_NAME		"br0:1"

#define DHCP_ACL_OPTION_POLICY_INCLUDE				0
#define DHCP_ACL_OPTION_POLICY_EXCLUDE				1

#define OPTION61_DUID_LLT								1
#define OPTION61_DUID_EN								2
#define OPTION61_DUID_LL								3
#define OPTION61_DUID_OTHER							4

#define DHCP_ACL_POOL_INDEX_OP60_VENDER_POLICY		'0'
#define DHCP_ACL_POOL_INDEX_OP60_VENDER				'1'
#define DHCP_ACL_POOL_INDEX_OP61_IAID				'2'
#define DHCP_ACL_POOL_INDEX_OP61_DUIDTYPE			'3'
#define DHCP_ACL_POOL_INDEX_OP61_ENTERPRISE			'4'
#define DHCP_ACL_POOL_INDEX_OP61_HWTYPE				'5'
#define DHCP_ACL_POOL_INDEX_OP61_TIME				'6'
#define DHCP_ACL_POOL_INDEX_OP61_MAC				'7'
#define DHCP_ACL_POOL_INDEX_OP61_ID_POLICY			'8'
#define DHCP_ACL_POOL_INDEX_OP61_IDENTIFIER			'9'
#define DHCP_ACL_POOL_INDEX_OP61_OTHERDUID			'a'
#define DHCP_ACL_POOL_INDEX_OP125_ENTERPRISE		'b'
#define DHCP_ACL_POOL_INDEX_OP125_OUI				'c'
#define DHCP_ACL_POOL_INDEX_OP125_PCLASS			'd'
#define DHCP_ACL_POOL_INDEX_OP125_MODEL				'e'
#define DHCP_ACL_POOL_INDEX_OP125_SERAIL_POLICY		'f'
#define DHCP_ACL_POOL_INDEX_OP125_SERAIL				'g'
#define DHCP_ACL_POOL_INDEX_VLAN						'h'
#endif
