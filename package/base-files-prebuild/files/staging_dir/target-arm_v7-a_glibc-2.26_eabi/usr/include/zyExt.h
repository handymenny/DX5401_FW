...
tr98Parameter_t para_TTCfgIPV6Lan[];
zcfgRet_t ttcfgIpV6LanQuery(char *, int , struct json_object **, bool );
zcfgRet_t ttcfgIpV6LanSet(char *, int , struct json_object *, struct json_object *, char *);
#endif
...
extern tr98Parameter_t para_EasyMeshTs[];
#endif
...
extern tr98Parameter_t para_Twampd[];
#endif
...
extern tr98Parameter_t para_QuickWanBridge[];
extern tr98Parameter_t para_TTQBridging[];
...
#ifdef TT_HGW
extern tr98Parameter_t para_DnsSrv[];
#endif
#endif
...
#ifdef TT_HGW
extern tr98Parameter_t para_TTCWMP[];
#endif
...
extern tr98Parameter_t para_Fsecure[];
#endif
...
#ifdef ZYXEL_EASYMESH_R2
extern zcfgRet_t zyExtEasyMeshTsObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyExtEasyMeshTsObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj, char *paramfault);
#endif
...
#ifdef CONFIG_ZCFG_BE_MODULE_TWAMP
/* InternetGatewayDevice.X_ZYXEL_EXT.TWAMPReflector */
extern zcfgRet_t zyExtTwampdObjGet(char *, int, struct json_object **, bool);
extern zcfgRet_t zyExtTwampdObjSet(char *, int, struct json_object *, struct json_object *);
#endif
...
#else
extern zcfgRet_t zyTTInetObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyTTInetObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
extern zcfgRet_t zyTTInetObjNotify(char *, char *, struct json_object *, int, struct json_object **);
extern int zyTTInetObjAttrGet(char *, int, char *);
extern zcfgRet_t zyTTInetObjAttrSet(char *, int, char *, int , struct json_object *);
extern zcfgRet_t zyTTMamgObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyTTMamgObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
extern zcfgRet_t zyTTMamgObjNotify(char *, char *, struct json_object *, int, struct json_object **);
extern int zyTTMamgObjAttrGet(char *, int, char *);
extern zcfgRet_t zyTTMamgObjAttrSet(char *, int, char *, int , struct json_object *);
extern zcfgRet_t zyTTVoIPObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyTTVoIPObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
extern zcfgRet_t zyTTVoIPObjNotify(char *, char *, struct json_object *, int, struct json_object **);
extern int zyTTVoIPObjAttrGet(char *, int, char *);
extern zcfgRet_t zyTTVoIPObjAttrSet(char *, int, char *, int , struct json_object *);
extern zcfgRet_t zyTTIPTVObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyTTIPTVObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
extern zcfgRet_t zyTTIPTVObjNotify(char *, char *, struct json_object *, int, struct json_object **);
extern int zyTTIPTVObjAttrGet(char *, int, char *);
extern zcfgRet_t zyTTIPTVObjAttrSet(char *, int, char *, int , struct json_object *);
#endif
...
extern zcfgRet_t zyTTQuickWanBridgeObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyTTQuickWanBridgeObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
extern zcfgRet_t zyTTQuickWanBridgeObjNotify(char *, char *, struct json_object *, int, struct json_object **);
extern int zyTTQuickWanBridgeObjAttrGet(char *, int, char *);
extern zcfgRet_t zyTTQuickWanBridgeObjAttrSet(char *, int, char *, int , struct json_object *);

//#ifdef TT_CUSTOMIZATION_QUICK_BRIDGING
...
#ifdef TT_HGW
extern zcfgRet_t zyTTDnsSrvObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyTTDnsSrvObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
extern zcfgRet_t zyTTDnsSrvObjNotify(char *, char *, struct json_object *, int, struct json_object **);
extern int zyTTDnsSrvObjAttrGet(char *, int, char *);
extern zcfgRet_t zyTTDnsSrvObjAttrSet(char *, int, char *, int , struct json_object *);
#endif
...
#endif
#ifdef TT_HGW
extern zcfgRet_t zyTTCWMPObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyTTCWMPObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
extern zcfgRet_t zyTTCWMPObjNotify(char *, char *, struct json_object *, int, struct json_object **);
extern int zyTTCWMPObjAttrGet(char *, int, char *);
extern zcfgRet_t zyTTCWMPObjAttrSet(char *, int, char *, int , struct json_object *);
#endif
#ifdef ZYXEL_IGMPDIAG 
...
#ifdef CONFIG_ZCFG_BE_MODULE_ZYXEL_FSECURE
extern zcfgRet_t zyExtFsecureObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t zyExtFsecureObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj);
#endif
...
extern tr98Parameter_t para_UsrIntf[];
extern zcfgRet_t usrIntfObjGet(char *tr98FullPathName, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t usrIntfObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj, char *paramfault);
extern zcfgRet_t usrIntfObjNotify(char *tr98ObjName, char *tr181ParamName, struct json_object *tr181ParamVal, int handler, struct json_object **tr98NotifyInfo);
extern int usrIntfObjAttrGet(char *tr98FullPathName, int handler, char *paramName);
extern zcfgRet_t usrIntfObjAttrSet(char *tr98FullPathName, int handler, char *paramName, int newNotify, struct json_object *multiAttrJobj);
