...
tr98Parameter_t para_WLANConfiguration[] = {
	{ "X_CUSTOM_PSK24", PARAMETER_ATTR_READONLY, 65, json_type_string},
	{ "X_CUSTOM_PSK5", PARAMETER_ATTR_READONLY, 65, json_type_string},
	{ NULL, 0, 0, 0}
};

tr98Parameter_t para_AccountResetPassword[] = {
	{ "Username", PARAMETER_ATTR_WRITE, 17, json_type_string},
	{ "X_CUSTOM_ResetDefaultPassword", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ NULL, 0, 0, 0}
};
...
#endif //ACEN_CUSTOMIZATION
#endif //ZYXEL_SFP_MODULE_SUPPORT
...
tr98Parameter_t para_EasyMeshTs[] = {
	{ "Enable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ NULL, 0, 0, 0}
};
#endif
...
tr98Parameter_t para_Twampd[] = {
	{ "Enable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "TcpPort", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
	{ "UdpPortStart", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
	{ "UdpPortEnd", PARAMETER_ATTR_WRITE, 0, json_type_uint32},
	{ "AuthenticationMode", PARAMETER_ATTR_WRITE, 16, json_type_string},
	{ "Username", PARAMETER_ATTR_WRITE, 64, json_type_string},
	{ "KeyPassphrase", PARAMETER_ATTR_WRITE | PARAMETER_ATTR_PASSWORD, 63, json_type_string},
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_TTCfgIPV6Lan[] = {
        { "Enabled", PARAMETER_ATTR_WRITE, true, json_type_boolean},
        { NULL, 0, 0, 0}
};
#endif
...
tr98Parameter_t para_TTQBridging[] = {
	{ "Enable", PARAMETER_ATTR_WRITE, 32, json_type_string},
	{ NULL, 0, 0, 0}
};

tr98Parameter_t para_QuickWanBridge[] = {
	{ "Enable", PARAMETER_ATTR_WRITE, 32, json_type_string},
	{ NULL, 0, 0, 0}
};
...
tr98Parameter_t para_TTPORTMIRROR[] = {
	...
	{ "Status", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "MonitorInterface", PARAMETER_ATTR_WRITE, 1500, json_type_string},
...
tr98Parameter_t para_TTWanConnDiagnostics[] = {
	...
	{ "Physical_WAN_Connection", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "Physical_1_Lan_ETH", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "Physical_2_Lan_ETH", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "Physical_3_Lan_ETH", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "Physical_4_Lan_ETH", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "Physical_1_FXS_Port", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "Physical_2_FXS_Port", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "Physical_History", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "Internet_ServiceState", PARAMETER_ATTR_READONLY, 0, json_type_boolean},
	...
	{ "Internet_History", PARAMETER_ATTR_READONLY, 64, json_type_string},
	...
	{ "IPTV_ServiceState", PARAMETER_ATTR_READONLY, 0, json_type_boolean},
	...
	{ "IPTV_History", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "Management_ServiceState", PARAMETER_ATTR_READONLY, 0, json_type_boolean},
	...
	{ "Management_History", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "VOIP_ServiceState", PARAMETER_ATTR_READONLY, 0, json_type_boolean},
	{ "VOIP_ConnectionStatus", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "VOIP_VlanID", PARAMETER_ATTR_READONLY, 0, json_type_int},
	{ "VOIP_IPAddress", PARAMETER_ATTR_READONLY, 128, json_type_string},
	{ "VOIP_DNS1", PARAMETER_ATTR_READONLY, 128, json_type_string},
	{ "VOIP_DNS2", PARAMETER_ATTR_READONLY, 128, json_type_string},
	{ "VOIP_PingGateway", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "VOIP_CheckDNS", PARAMETER_ATTR_READONLY, 128, json_type_string},
	{ "SIP_Server_DNS", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "SIP_Server_SRV1", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "SIP_Server_SRV2", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "FXS1_ServiceState", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "FXS1_Number", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "FXS1_RegisterServer", PARAMETER_ATTR_READONLY, 128, json_type_string},
	{ "FXS1_RegisterStatus", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "FXS2_ServiceState", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "FXS2_Number", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ "FXS2_RegisterServer", PARAMETER_ATTR_READONLY, 128, json_type_string},
	{ "FXS2_RegisterStatus", PARAMETER_ATTR_READONLY, 32, json_type_string},
	{ "VOIP_History", PARAMETER_ATTR_READONLY, 64, json_type_string},
	{ NULL, 0, 0, 0}
};
#endif
...
#if defined(CONFIG_ZCFG_BE_MODULE_ZYXEL_FSECURE)
tr98Parameter_t para_Fsecure[] = {
	{ "SENSE_Enable", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
	{ "SENSE_License_Key", PARAMETER_ATTR_WRITE, 254, json_type_string},
	{ "SENSE_Reset_Key", PARAMETER_ATTR_WRITE, 254, json_type_string},
	{ "SENSE_Activation_Status", PARAMETER_ATTR_WRITE, 1024, json_type_string},
	{ "SENSE_License_Status", PARAMETER_ATTR_WRITE, 1024, json_type_string},
	{ NULL, 0, 0, 0}
};
#endif
...
tr98Parameter_t para_UsrIntf[] = {
	{ "PasswordRequired", PARAMETER_ATTR_READONLY, 0, json_type_boolean},
	{ "PasswordUserSelectable", PARAMETER_ATTR_READONLY, 0, json_type_boolean},
	{ "PasswordReset", PARAMETER_ATTR_WRITE, 0, json_type_boolean},
    { "ISPName", PARAMETER_ATTR_WRITE, 64, json_type_string},
    { "ISPHelpDesk", PARAMETER_ATTR_WRITE, 32, json_type_string},
    { "ISPHomePage", PARAMETER_ATTR_WRITE, 256, json_type_string},
    { "ISPHelpPage", PARAMETER_ATTR_WRITE, 256, json_type_string},
    { "ISPLogo", PARAMETER_ATTR_WRITE, 4095, json_type_base64},
    { "ISPLogoSize", PARAMETER_ATTR_WRITE, 4095, json_type_uint32},
    { "ISPMailServer", PARAMETER_ATTR_WRITE, 256, json_type_string},
    { "ISPNewsServer", PARAMETER_ATTR_WRITE, 256, json_type_string},
    { "X_ZYXEL_WarningMSG", PARAMETER_ATTR_WRITE, 256, json_type_string},
    { "TextColor", PARAMETER_ATTR_WRITE, 6, json_type_hex},
	{ NULL, 0, 0, 0}
};
