...
// #define WPS_ZYXEL_EXT_ETHPORT      0x05
#define WPS_ZYXEL_EXT_WLMODE       0x06
...
int zyMAP1905_ApCfg_parse_check_len(unsigned char *q, unsigned int len, zyMAP1905_bssInfo *bssInfo_recv);
