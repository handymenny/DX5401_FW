...
typedef enum {
	...
	FWCTRL_DOWNLOAD_INCOMPLETED = 0x71,		/**< Network fwctrl download status is incompleted */
	FWCTRL_DOWNLOAD_COMPLETED = 0x72		/**< Network fwctrl download status is completed */
} RetCode;
