...
#define FWCTRL_DL_SH			"/etc/zy1905/zy1905_fwctrl_dl.sh"
#define FWCTRL_SH_FWNAME		"/etc/zy1905/zy1905_fwctrl_ras.bin"
#define FWCTRL_SH_STATUS		"/etc/zy1905/zy1905_fwctrl_dl_st"
#define FWCTRL_UP_SH			"/etc/zy1905/zy1905_fwctrl_upgrade.sh"
#endif
...
#if defined(ZYXEL_ZY1905_VER_30_SUPPORT_FWUPGRADE)
#define FW_STATE_DOWNLOAD_FW_STR		"FWCTRL_ST: DOWNLOADING"
#define FW_STATE_FINISH_DOWNLOAD_FW_STR	"FWCTRL_ST: DOWNLOAD DONE"
#define FW_STATE_FW_UPGRADE_STR			"FWCTRL_ST: UPGRADE"
#endif
...
#if defined(ZYXEL_ZY1905_VER_30_SUPPORT_FWUPGRADE)
RetCode zyFWCtrl(int ActionOption, int URLOption, char URL[1024], char *user, char *passwd);
#else
