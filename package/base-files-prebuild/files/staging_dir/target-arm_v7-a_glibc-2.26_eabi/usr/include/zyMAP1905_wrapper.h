...
typedef int zy1905bcm_sendVendSpecRelayMcast(zy1905VendorData *msg_data, unsigned short *msgId);
...
typedef struct zy1905_call_bks {
    ...
    zy1905bcm_sendVendSpecRelayMcast *sendVendSpecRelayMcast;
...
RetCode zyMAP1905_VenderSpecRelayMcastMsg_send(unsigned char *specData, unsigned short *msgId);
