...
#ifdef ZYXEL_SUPPORT_LONG_BYTE_SERIAL_NUMBER
#define SERIAL_NUM_STR_NORMAL_LEN  32	// not include EOL
#else
...
/*!
 *  Check romfile partition has TE_config.rom or not
 *
 *  @return                     1: in smt mode ; 0: dosen't.
 */
