...
typedef struct zyWlanEasyMesh_s {
	...
	bool configured; /*Auto config done or not*/
		...
		int role;
#endif
#ifdef ZYXEL_ECONET_STANDALONE_BAND_STEERING
	bool standalonebs;
#endif
...
#if defined(ZYXEL_DPP_R2)
#define WL_AUTH_DPP             6
#define WL_AUTH_WPA3DPP_MIX     7
#define WL_AUTH_WPA2WPA3DPP_MIX 8
#endif
...
#ifdef ZYXEL_EASYMESH_R2
extern bool ts_active; /* TS enable and Guest SSID enable, TS would active */
extern bool ts_change; /* TS was change from enable to disable, or disable to enable*/
