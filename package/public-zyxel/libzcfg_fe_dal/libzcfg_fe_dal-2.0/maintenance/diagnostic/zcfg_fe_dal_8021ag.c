...
zcfgRet_t zcfgFeDal8021agCfg(struct json_object *Jobj)
{
	...
	struct json_object *ieee8021agobj = NULL;
	objIndex_t ieee8021agIid;
	bool EthOAM_TMS = false, Enabled = false, CCMEnabled = false, Y1731Mode = false;
	unsigned int MDLevel = 0, LMPID = 0, RMPID = 0, VLANID = 0;
	char *Interface = NULL, *MAID = NULL, *MDName = NULL;
...
zcfgRet_t zcfgFeDalLoopBack(struct json_object *Jobj)
{
	...
	struct json_object *ieee8021agobj = NULL;
	objIndex_t ieee8021agIid;
	unsigned int MDLevel = 0, VLANID = 0;
	char *DestMacAddress = NULL;
	bool SendLoopBack = false;
...
{
	zcfgRet_t ret = ZCFG_SUCCESS;
	unsigned int type = TYPE_INIT;
    bool Y1731Mode = false;
    char *MDName = NULL;
...
zcfgRet_t zcfgFeDal8021agGet(struct json_object *Jobj, struct json_object *Jarray, char *replyMsg, uint32_t flag1)
{
	zcfgRet_t ret = ZCFG_SUCCESS;
	struct json_object *obj = NULL, *interfaceList = NULL, *ieee8021agobj = NULL;
	char pathString[30] = "";
	objIndex_t objIid;
	objIndex_t ieee8021agIid;
...
zcfgRet_t zcfgFe8021ag(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg)
{
	...
	if(!strcmp(method, "GET")) {
		ret = zcfgFeDal8021agGet(Jobj, Jarray, NULL, flag1);
	}
