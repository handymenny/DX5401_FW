...
#ifdef ZYXEL_WWAN_CHECK_IPV6_ADDRESS
{"Ping_Destination_IPv6", dalType_string,	0,	64,	NULL},
#endif
...
#ifdef ZYXEL_WWAN_CHECK_IPV6_ADDRESS
	const char *destination_ipv6 = NULL;
#endif
...
#ifdef ZYXEL_WWAN_CHECK_IPV6_ADDRESS
		destination_ipv6 = json_object_get_string(json_object_object_get(Jobj, "Ping_Destination_IPv6"));
#endif
#ifdef ZYXEL_CONFIGURABLE_WWANBACKUP_WAIT_TIME
...
#ifdef ZYXEL_WWAN_CHECK_IPV6_ADDRESS
		if(json_object_object_get(Jobj, "Ping_Destination_IPv6"))
		json_object_object_add(pingObj, "Destination_IPv6", json_object_new_string(destination_ipv6));
#endif
#ifdef ZYXEL_CONFIGURABLE_WWANBACKUP_WAIT_TIME
...
#ifdef ZYXEL_WWAN_CHECK_IPV6_ADDRESS
		json_object_object_add(paramJobj, "Ping_Destination_IPv6", JSON_OBJ_COPY(json_object_object_get(pingObj, "Destination_IPv6")));
#endif
#ifdef ZYXEL_CONFIGURABLE_WWANBACKUP_WAIT_TIME
...
#ifdef ZYXEL_WWAN_CHECK_IPV6_ADDRESS
		printf("%-30s %-10s \n","Ping Host:", json_object_get_string(json_object_object_get(obj, "Ping_Destination_IPv6")));
#endif
	}
