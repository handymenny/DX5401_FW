...
#ifdef ZYXEL_DPP_R2
 			if(strcmp(wpaMode,"wpapsk") && strcmp(wpaMode,"wpa2psk") && strcmp(wpaMode,"wpa2") && strcmp(wpaMode,"wpa3sae") && strcmp(wpaMode,"wpa2pskwpa3sae") && strcmp(wpaMode,"dpp") && strcmp(wpaMode,"wpa3saedpp") && strcmp(wpaMode,"wpa2pskwpa3saedpp")){
				printf("wpaMode must be set to \"wpapsk\" or \"wpa2psk\" or \"wpa2\" or \"wpa3sae\" or \"wpa2pskwpa3sae\" or \"dpp\" or \"wpa3saedpp\" or \"wpa2pskwpa3saedpp\".\n");
				return ZCFG_INVALID_PARAM_VALUE;
			}
#else//ZYXEL_DPP_R2
...
zcfgRet_t zcfgFeDalWifiGeneral(const char *method, struct json_object *Jobj, struct json_object *Jarray, char *replyMsg){
	...
	if ((json_object_get_type(Jobj) == json_type_array) && (!strcmp(method, "PUT")))
	{
		...
		for (idx = 0; idx < arrLen; idx++) {
			...
			if(checkSSID!=NULL && strcmp("",checkSSID)==0){
                json_object_object_add(obj, "__multi_lang_replyMsg", json_object_new_string("zylang.Wireless_page.General.InvalidWirelessNetworkName"));
                return ZCFG_INVALID_PARAM_VALUE;
            }
