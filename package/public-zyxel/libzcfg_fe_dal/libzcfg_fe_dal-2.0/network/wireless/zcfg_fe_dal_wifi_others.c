...
#ifdef ZYXEL_WEB_GUI_WLAN_DFS_SW
	{"X_ZYXEL_RegMode", 			        dalType_int, 		0,	0, 	NULL,	NULL,	dalcmd_Forbid},
#endif	
#ifdef ZYXEL_WEB_GUI_WIFI_COUNTRYCODE_SELECT
	{"X_ZYXEL_CountryCode",		dalType_string,		0,	0,	NULL,	NULL,	dalcmd_Forbid},
#endif 
...
#ifdef ZYXEL_WEB_GUI_WIFI_COUNTRYCODE_SELECT
	json_object_object_add(pramJobj, "X_ZYXEL_CountryCode", JSON_OBJ_COPY(json_object_object_get(RadioObj, "X_ZYXEL_CountryCode")));
#endif
...
#ifdef ZYXEL_WEB_GUI_WLAN_DFS_SW
	json_object_object_add(pramJobj, "X_ZYXEL_RegMode", JSON_OBJ_COPY(json_object_object_get(RadioObj, "X_ZYXEL_RegMode")));
#endif
...
#ifdef ZYXEL_WEB_GUI_WLAN_DFS_SW
	regmode_ori = json_object_get_int(json_object_object_get(RadioObj, "X_ZYXEL_RegMode"));
#endif

#ifdef ZYXEL_WEB_GUI_WIFI_COUNTRYCODE_SELECT
	country_ori = json_object_get_string(json_object_object_get(RadioObj, "X_ZYXEL_CountryCode"));
#endif
...
#ifdef ZYXEL_WEB_GUI_WLAN_DFS_SW
	regmode = json_object_get_int(json_object_object_get(Jobj, "X_ZYXEL_RegMode"));
#endif
...
#ifdef ZYXEL_WEB_GUI_WIFI_COUNTRYCODE_SELECT
	country = json_object_get_string(json_object_object_get(Jobj, "X_ZYXEL_CountryCode"));
#endif
...
#ifdef ZYXEL_WEB_GUI_WIFI_COUNTRYCODE_SELECT
	if(json_object_object_get(Jobj, "X_ZYXEL_CountryCode")){
		countrycode = json_object_get_string(json_object_object_get(Jobj, "X_ZYXEL_CountryCode"));
		if(!strcmp(countrycode,"US/8") || !strcmp(countrycode,"EU/8")){
			json_object_object_add(wifiRadioOthersObj, "X_ZYXEL_CountryCode", json_object_new_string(country));
			if(!strcmp(countrycode,"US/8"))
				json_object_object_add(wifiRadioOthersObj, "RegulatoryDomain", json_object_new_string("US"));
			else
				json_object_object_add(wifiRadioOthersObj, "RegulatoryDomain", json_object_new_string("EU"));
			}
	}
#endif
...
#ifdef ZYXEL_WEB_GUI_WLAN_DFS_SW
	if(json_object_object_get(Jobj, "X_ZYXEL_RegMode"))
		json_object_object_add(wifiRadioOthersObj, "X_ZYXEL_RegMode", json_object_new_int(regmode));
#endif
