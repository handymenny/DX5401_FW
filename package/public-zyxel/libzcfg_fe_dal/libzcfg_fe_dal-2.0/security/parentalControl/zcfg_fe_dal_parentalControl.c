...
#if defined(ZYXEL_TT_CUSTOMIZATION) && !defined(TT_HGW)	//TT customized
...
#if defined(ZYXEL_TT_CUSTOMIZATION) && !defined(TT_HGW)//TT
...
#if defined(ZYXEL_TT_CUSTOMIZATION) && !defined(TT_HGW)
...
#if !defined(ZYXEL_HOME_CYBER_SECURITY) || defined(ZYXEL_USA_PRODUCT) || defined (YAD_PARENT_CONTROL_CUSTOMIZATION)
	char *_day = NULL;
#endif
	char *ptr, *tmp;
...
#ifdef YAD_PARENT_CONTROL_CUSTOMIZATION
			else{
				Jadds(schRuleJobj, "Type", "NULL");
			}
#endif
