...
extern tr98Parameter_t para_LanIPv6HostCfgMgmt[];
#endif
...
/*InternetGatewayDevice.X_CUSTOM_NeighboringWiFiDiagnostic*/
#else
...
#ifdef ACEN_CUSTOMIZATION
/*InternetGatewayDevice.X_CUSTOM_NeighboringWiFiDiagnostic.Result.i*/
#else
...
extern zcfgRet_t lanV6HostCfgMgmtGet(char *tr98Path, int handler, struct json_object **tr98Jobj, bool updateFlag);
extern zcfgRet_t lanV6HostCfgMgmtSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj, char *paramfault);
#endif
