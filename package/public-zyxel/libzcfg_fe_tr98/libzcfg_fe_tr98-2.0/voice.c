...
zcfgRet_t voiceProfFaxT38ObjSet(char *tr98FullPathName, int handler, struct json_object *tr98Jobj, struct json_object *multiJobj, char *paramfault)
{
	...
	/*yushiuan add for ACEN , Because ACEN need control Oid: RDM_OID_VOICE_PROF_FAX_T38 , parameter : Enable via TR069 ,
...
#if defined (ZYPRJ_CUSTOMER_ACEN) || defined (ACEN_CUSTOMIZATION)//0-base
		phyPort = phyPort+1;
#endif
