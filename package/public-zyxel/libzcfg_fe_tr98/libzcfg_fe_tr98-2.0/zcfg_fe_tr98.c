...
// TTG, TTNET
{e_TR98_LAN_DEV_TT_V6_HOST_CFG_MGMT, &tr98Obj[e_TR98_LAN_DEV_TT_V6_HOST_CFG_MGMT -e_TR98_START]},
#endif
...
{e_TR98_TT_H323Alg				, &tr98Obj[e_TR98_TT_H323Alg 			  -e_TR98_START]},
{e_TR98_TT_SIPAlg				, &tr98Obj[e_TR98_TT_SIPAlg			  -e_TR98_START]},
{e_TR98_TT_RTSPAlg				, &tr98Obj[e_TR98_TT_RTSPAlg			  -e_TR98_START]},
{e_TR98_TT_PPTPAlg				, &tr98Obj[e_TR98_TT_PPTPAlg			  -e_TR98_START]},
{e_TR98_TT_IPSecAlg				, &tr98Obj[e_TR98_TT_IPSecAlg			  -e_TR98_START]},
{e_TR98_TT_L2TPAlg				, &tr98Obj[e_TR98_TT_L2TPAlg			  -e_TR98_START]},
{e_TR98_TT_IGMPProxy			, &tr98Obj[e_TR98_TT_IGMPProxy			  -e_TR98_START]},
{e_TR98_TT_SMTP					, &tr98Obj[e_TR98_TT_SMTP			  -e_TR98_START]},
{e_TR98_TT_ICMP 				, &tr98Obj[e_TR98_TT_ICMP			  -e_TR98_START]},
{e_TR98_TT_NTP 				, &tr98Obj[e_TR98_TT_NTP			  -e_TR98_START]},
#endif
#ifdef ZYXEL_TTNET_EDNS// Add ppp username to edns option for TT
{e_TR98_TT_EDNS					, &tr98Obj[e_TR98_TT_EDNS 			  -e_TR98_START]},
#endif
#if (defined(CONFIG_TT_PORTMIRROR) || defined(CONFIG_TT_PORTMIRROR_E))
{e_TR98_TT_PORTMIRROR		, &tr98Obj[e_TR98_TT_PORTMIRROR			  -e_TR98_START]},
#endif
#ifdef CONFIG_ZCFG_BE_MODULE_PKT_CAPTURE
{e_TR98_TT_PACKETCAPTURE		, &tr98Obj[e_TR98_TT_PACKETCAPTURE			  -e_TR98_START]},
{e_TR98_TT_PACKETCAPTUREUPLOAD		, &tr98Obj[e_TR98_TT_PACKETCAPTUREUPLOAD			  -e_TR98_START]},
#endif
#ifdef TT_HGW
{e_TR98_TT_CWMP		, &tr98Obj[e_TR98_TT_CWMP			  -e_TR98_START]},
#endif
#if ZYXEL_EXT
...
{e_TR98_ACEN_EXT               , &tr98Obj[e_TR98_ACEN_EXT               -e_TR98_START]},
...
{e_TR98_FSECURE					, &tr98Obj[e_TR98_FSECURE					-e_TR98_START]},
#endif
#ifdef CONFIG_ZCFG_BE_MODULE_IPK_PACKAGE
...
{e_TR98_EasyMeshTs                    , &tr98Obj[e_TR98_EasyMeshTs          -e_TR98_START]},
#endif
...
{e_TR98_TT_Configuration_Button				, &tr98Obj[e_TR98_TT_Configuration_Button					-e_TR98_START]},
{e_TR98_TT_Configuration_Button_WiFi		, &tr98Obj[e_TR98_TT_Configuration_Button_WiFi					-e_TR98_START]},
#endif
#ifdef CONFIG_ZCFG_BE_MODULE_ZYXEL_QUANTWIFI
{e_TR98_TT_Configuration_Quantwifi			, &tr98Obj[e_TR98_TT_Configuration_Quantwifi					-e_TR98_START]},
#endif
#ifdef CONFIG_ZCFG_BE_MODULE_TWAMP
{e_TR98_TWAMPD						, &tr98Obj[e_TR98_TWAMPD					-e_TR98_START]},
...
{e_TR98_TT_Function				, &tr98Obj[e_TR98_TT_Function			  -e_TR98_START]},
#endif
#ifdef ZYXEL_IGMPDIAG
{e_TR98_TTIGMPDiagnostics			, &tr98Obj[e_TR98_TTIGMPDiagnostics			  -e_TR98_START]},
#endif
#ifdef ZYXEL_TT_WAN_CONN_DIAG
{e_TR98_TT_WanConnDiagnostics			, &tr98Obj[e_TR98_TT_WanConnDiagnostics			  -e_TR98_START]},
#endif
#ifdef ZYXEL_CUSTOMIZATION_SYSLOG
{e_TR98_TT_Syslog				, &tr98Obj[e_TR98_TT_Syslog 			  -e_TR98_START]},
{e_TR98_TT_SyslogUpload				, &tr98Obj[e_TR98_TT_SyslogUpload			  -e_TR98_START]},
#endif
#ifdef TT_CUSTOMIZATION_V6
#ifndef TT_CUSTOMIZATION_V6_TTNET
{e_TR98_TTG					, &tr98Obj[e_TR98_TTG						-e_TR98_START]},
{e_TR98_TTG_CFG					, &tr98Obj[e_TR98_TTG_CFG				-e_TR98_START]},
{e_TR98_TTG_CFG_IPV6LAN				, &tr98Obj[e_TR98_TTG_CFG_IPV6LAN	-e_TR98_START]},
#else
{e_TR98_TT_CFG_IPV6LAN				, &tr98Obj[e_TR98_TT_CFG_IPV6LAN	-e_TR98_START]},
#endif
#endif
#if defined(MSTC_TTNET_MULTI_USER) || defined(MSTC_RETAIL_MULTI_USER) || defined(TENDER_TT_FEATURE)
{e_TR98_TT               , &tr98Obj[e_TR98_TT               -e_TR98_START]},
{e_TR98_TT_Users				, &tr98Obj[e_TR98_TT_Users 			  -e_TR98_START]},
{e_TR98_TT_Users_User				, &tr98Obj[e_TR98_TT_Users_User 			  -e_TR98_START]},
{e_TR98_TT_UserInterface				 , &tr98Obj[e_TR98_TT_UserInterface				-e_TR98_START]},
{e_TR98_TT_UserInterface_RemoteAccess				 , &tr98Obj[e_TR98_TT_UserInterface_RemoteAccess 			-e_TR98_START]},
{e_TR98_TT_UserInterface_LocalAccess				 , &tr98Obj[e_TR98_TT_UserInterface_LocalAccess 			-e_TR98_START]},
{e_TR98_TT_Firewall				 , &tr98Obj[e_TR98_TT_Firewall 			-e_TR98_START]},
{e_TR98_TT_UPnP				 , &tr98Obj[e_TR98_TT_UPnP 			-e_TR98_START]},
{e_TR98_TT_UPnP_Device				 , &tr98Obj[e_TR98_TT_UPnP_Device 			-e_TR98_START]},
{e_TR98_TT_Configuration				 , &tr98Obj[e_TR98_TT_Configuration				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI				 , &tr98Obj[e_TR98_TT_Configuration_GUI				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Broad				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Broad				-e_TR98_START]},
#ifndef TT_HGW
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_InetDSL				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_InetDSL				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_InetWAN				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_InetWAN				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTVDSL				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTVDSL				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTVWAN				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTVWAN				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_MamgWAN				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_MamgWAN				-e_TR98_START]},
#else
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Inet				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Inet				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Mamg				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Mamg				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_VoIP				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_VoIP				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTV				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTV				-e_TR98_START]},
#endif
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_ACSDSL 			 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_ACSDSL				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_ACSWAN 			 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_ACSWAN				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Advanced				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Advanced				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_General				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_General				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_MoreAP				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_MoreAP				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_WPS				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_WPS				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_WMM				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_WMM				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_Others				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_Others				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNetworking				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNetworking				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNking_LANSetup				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNking_LANSetup				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNking_LANVLAN				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNking_LANVLAN				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Routing				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Routing				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_NAT				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_NAT				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_NAT_ALG				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_NAT_ALG				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Security				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Security				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Security_Firewall				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Security_Firewall				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Security_Firewall_DoS				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Security_Firewall_DoS				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_SystemMonitor				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_SystemMonitor				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_SystemMonitor_Log				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_SystemMonitor_Log				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance 			-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_RemoteMGMT				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_RemoteMGMT				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_TR069				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_TR069				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_Time				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_Time				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_LogSetting				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_LogSetting				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_FirmwareUpgrade				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_FirmwareUpgrade				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_Configuration				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_Configuration				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_EDNS				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_EDNS 			-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Engdebug				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Engdebug				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Capture				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Capture 			-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu 			 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu			-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu_EM_RemoteAccess 			 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu_EM_RemoteAccess				-e_TR98_START]},
{e_TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu_EM_LocalAccess				 , &tr98Obj[e_TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu_EM_LocalAccess				-e_TR98_START]},
{e_TR98_TT_Configuration_Shell				 , &tr98Obj[e_TR98_TT_Configuration_Shell			-e_TR98_START]},
{e_TR98_TT_Configuration_QuickWanBridge		 , &tr98Obj[e_TR98_TT_Configuration_QuickWanBridge			-e_TR98_START]},
{e_TR98_TT_CFG_QUICK_ATA_BR		, &tr98Obj[e_TR98_TT_CFG_QUICK_ATA_BR	-e_TR98_START]},
#ifdef TT_HGW
{e_TR98_TT_Configuration_SIP 	, &tr98Obj[e_TR98_TT_Configuration_SIP	-e_TR98_START]},
{e_TR98_TT_Configuration_DnsSrv 	, &tr98Obj[e_TR98_TT_Configuration_DnsSrv	-e_TR98_START]},
#endif
...
#ifdef CONFIG_ZCFG_BE_MODULE_OI_CUSTOMIZATION
...
#ifdef ACEN_CUSTOMIZATION
	if(!wanDeviceName || strstr(tr98ObjName, "X_CUSTOM_ActiveWANDevice.1"))
#else
...
#if 1 //multiObj RDM_OID_ROUTING_ROUTER issue
char FeActiveV4GW[513]={0};
char FeActiveV6GW[513]={0};
zcfgRet_t zcfgFeTr98MultiObjSet(char *tr98ObjName, struct json_object *value, struct json_object *multiJobj, char *paramfault, char *activeV4GW, char *activeV6GW)
#else
...
#if 1 //multiObj RDM_OID_ROUTING_ROUTER issue
		if(activeV4GW){
			zos_snprintf(FeActiveV4GW, sizeof(FeActiveV4GW), "%s",  activeV4GW);
		}else{
			memset(FeActiveV4GW, 0, sizeof(FeActiveV4GW));
		}

		if(activeV6GW){
			zos_snprintf(FeActiveV6GW, sizeof(FeActiveV6GW), "%s",  activeV6GW);
		}else{
			memset(FeActiveV6GW, 0, sizeof(FeActiveV6GW));
		}
#endif	
		if(tr98Obj[handler].setObj != NULL && newtr98ObjName[0] != '\0'){
...
int zcfgJsonObjectValueCmp(struct json_object *paramValue_1, struct json_object *paramValue_2, json_type type)
{

	if((paramValue_1 && !paramValue_2) || (!paramValue_1 && paramValue_2))
		return 1;

	if(!paramValue_1 && !paramValue_2)
		return 0;

	if(type == json_type_string)
	{
		const char *paramValue_1_str = json_object_get_string(paramValue_1);
		const char *paramValue_2_str = json_object_get_string(paramValue_2);

		return strncmp(paramValue_1_str, paramValue_2_str, (strlen(paramValue_1_str) >= strlen(paramValue_2_str)) ? strlen(paramValue_1_str) : strlen(paramValue_2_str));
	}
	else if(type == json_type_boolean)
	{
		bool paramValue_1_bool = json_object_get_boolean(paramValue_1);
		bool paramValue_2_bool = json_object_get_boolean(paramValue_2);

		return (paramValue_1_bool == paramValue_2_bool) ? 0 : 1;
	}
...
#define QUICK_ATA_BRIDGING "Bridge_ATA"

bool zcfgFeCheckQuickBridging(objIndex_t *objIid)
{
	struct json_object *bridgingObj = NULL;
	const char *bridgingName;
	bool qBridging = false;

	if(zcfgFeObjJsonGetWithoutUpdate(RDM_OID_BRIDGING_BR, objIid, &bridgingObj) == ZCFG_SUCCESS)
	{
		bridgingName = json_object_get_string(json_object_object_get(bridgingObj, "X_ZYXEL_BridgeName"));
		if(bridgingName && strstr(bridgingName, QUICK_ATA_BRIDGING))
		{
			qBridging = true;
		}

		json_object_put(bridgingObj);
	}
