...
int zcfgJsonObjectValueCmp(struct json_object *, struct json_object *, json_type );
...
zcfgRet_t zcfgFeTr98MultiObjSet(char *, struct json_object *, struct json_object *, char *paramfault, char *activeV4GW, char *activeV6GW);
#else
