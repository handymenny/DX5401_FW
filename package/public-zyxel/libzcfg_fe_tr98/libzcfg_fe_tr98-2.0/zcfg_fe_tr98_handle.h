...
#ifdef TT_CUSTOMIZATION_V6
#ifndef TT_CUSTOMIZATION_V6_TTNET
#define TR98_LAN_DEV_TT_V6_HOST_CFG_MGMT  "InternetGatewayDevice.LANDevice.i.X_TTG_LANIPv6HostConfigManagement"
#else
#define TR98_LAN_DEV_TT_V6_HOST_CFG_MGMT  "InternetGatewayDevice.LANDevice.i.X_TTNET_LANIPv6HostConfigManagement"
#endif
#endif
...
#define TR98_NEIBOR_WIFI_DIAG         "InternetGatewayDevice.X_CUSTOM_NeighboringWiFiDiagnostic"
#define TR98_NEIBOR_WIFI_DIAG_RESULT  "InternetGatewayDevice.X_CUSTOM_NeighboringWiFiDiagnostic.Result.i"
#else
...
#ifdef ZYXEL_TTNET_TR69ALG////MSTC_TTALG, RichardFeng
#define TR98_TT_H323Alg                "InternetGatewayDevice.X_TTNET.Configuration.H323_ALG"
#define TR98_TT_SIPAlg                 "InternetGatewayDevice.X_TTNET.Configuration.SIP_ALG"
#define TR98_TT_RTSPAlg                "InternetGatewayDevice.X_TTNET.Configuration.RTSP_ALG"
#define TR98_TT_PPTPAlg                "InternetGatewayDevice.X_TTNET.Configuration.PPTP_ALG"
#define TR98_TT_IPSecAlg               "InternetGatewayDevice.X_TTNET.Configuration.IPSec_ALG"
#define TR98_TT_L2TPAlg                "InternetGatewayDevice.X_TTNET.Configuration.L2TP_ALG"
#define TR98_TT_IGMPProxy              "InternetGatewayDevice.X_TTNET.Configuration.IGMPProxy"
#define TR98_TT_SMTP               	   "InternetGatewayDevice.X_TTNET.Configuration.SMTP"
#define TR98_TT_ICMP	               "InternetGatewayDevice.X_TTNET.Configuration.ICMP"
#define TR98_TT_NTP               	   "InternetGatewayDevice.X_TTNET.Configuration.NTP"
#endif
#ifdef ZYXEL_TTNET_EDNS//Add ppp username to edns option for TT
#define TR98_TT_EDNS             	   "InternetGatewayDevice.X_TTNET.Configuration.EDNS"
#endif

#if (defined(CONFIG_TT_PORTMIRROR) || defined(CONFIG_TT_PORTMIRROR_E))
#define TR98_TT_PORTMIRROR                "InternetGatewayDevice.X_TTNET.PortMirroring"
#endif

#ifdef CONFIG_ZCFG_BE_MODULE_PKT_CAPTURE
#define TR98_TT_PACKETCAPTURE                "InternetGatewayDevice.X_TTNET.PacketCapture"
#define TR98_TT_PACKETCAPTUREUPLOAD                "InternetGatewayDevice.X_TTNET.PacketCapture.Upload"
#endif

#ifdef TT_HGW
#define TR98_TT_CWMP                "InternetGatewayDevice.X_TTNET.CWMP"
#endif
...
#ifdef ACEN_CUSTOMIZATION
#define TR98_ACEN_EXT                  "InternetGatewayDevice.X_CUSTOM"
#define TR98_D_DNS                    "InternetGatewayDevice.X_CUSTOM.DynamicDNS"
#else
...
#ifdef ACEN_CUSTOMIZATION
#define TR98_GPON_INFO                "InternetGatewayDevice.X_CUSTOM_Gpon_Info"
#else //orig
#define TR98_GPON_INFO                "InternetGatewayDevice.X_ZYXEL_EXT.Gpon_Info"
#endif //ACEN_CUSTOMIZATION
#endif //CONFIG_ZCFG_BE_MODULE_GPON_INFO
...
#ifdef ACEN_CUSTOMIZATION
#define TR98_VendorEasyMesh		"InternetGatewayDevice.X_CUSTOM_Mesh"
#endif //ACEN_CUSTOMIZATION
#endif
#ifdef ZYXEL_EASYMESH_R2
#define TR98_EasyMeshTs             "InternetGatewayDevice.X_ZYXEL_EXT.EasyMeshTs"
#endif
...
#ifdef ZYXEL_ONESSID
#ifdef ACEN_CUSTOMIZATION
#define TR98_ONESSID                  "InternetGatewayDevice.X_CUSTOM_ONESSID"
#else //ORIG
...
#define TR98_TT_Configuration_Button             "InternetGatewayDevice.X_TTNET.Configuration.Buttons"
#define TR98_TT_Configuration_Button_WiFi               "InternetGatewayDevice.X_TTNET.Configuration.Buttons.WiFi"
#endif

#ifdef CONFIG_ZCFG_BE_MODULE_ZYXEL_QUANTWIFI
#define TR98_TT_Configuration_Quantwifi            "InternetGatewayDevice.X_TTNET.Configuration.QuantWiFiAgent"
#endif
...
#define TR98_TWAMPD							"InternetGatewayDevice.X_ZYXEL_EXT.TWAMPReflector"
#endif
...
#define TR98_TT_Function                "InternetGatewayDevice.X_TTNET.Function"
#endif
#ifdef ZYXEL_IGMPDIAG
#define TR98_TTIGMPDiagnostics           "InternetGatewayDevice.X_TTNET.Function.IGMPDiagnostics"
#endif
#ifdef ZYXEL_TT_WAN_CONN_DIAG
#define TR98_TT_WanConnDiagnostics    "InternetGatewayDevice.X_TTNET.Function.Connection"
#endif
#ifdef ZYXEL_CUSTOMIZATION_SYSLOG
#define TR98_TT_Syslog                "InternetGatewayDevice.X_TTNET.Configuration.Syslog"
#define TR98_TT_SyslogUpload                "InternetGatewayDevice.X_TTNET.Function.SyslogUpload"
#endif

#ifdef TT_CUSTOMIZATION_V6
#ifndef TT_CUSTOMIZATION_V6_TTNET
#define TR98_TTG              "InternetGatewayDevice.X_TTG"
#define TR98_TTG_CFG          "InternetGatewayDevice.X_TTG.Configuration"
#define TR98_TTG_CFG_IPV6LAN  "InternetGatewayDevice.X_TTG.Configuration.IPv6Lan"
#else
#define TR98_TT_CFG_IPV6LAN  "InternetGatewayDevice.X_TTNET.Configuration.IPv6Lan"
#endif
#endif

#if defined(MSTC_TTNET_MULTI_USER) || defined(MSTC_RETAIL_MULTI_USER) || defined(TENDER_TT_FEATURE)
#define TR98_TT                "InternetGatewayDevice.X_TTNET"
#define TR98_TT_Users                "InternetGatewayDevice.X_TTNET.Users"
#define TR98_TT_Users_User                "InternetGatewayDevice.X_TTNET.Users.User.i"
#define TR98_TT_UserInterface                "InternetGatewayDevice.X_TTNET.UserInterface"
#define TR98_TT_UserInterface_RemoteAccess                "InternetGatewayDevice.X_TTNET.UserInterface.RemoteAccess"
#define TR98_TT_UserInterface_LocalAccess                "InternetGatewayDevice.X_TTNET.UserInterface.LocalAccess"
#define TR98_TT_Firewall  				"InternetGatewayDevice.X_TTNET.Firewall"
#define TR98_TT_UPnP                "InternetGatewayDevice.X_TTNET.UPnP"
#define TR98_TT_UPnP_Device                "InternetGatewayDevice.X_TTNET.UPnP.Device"
#define TR98_TT_Configuration                "InternetGatewayDevice.X_TTNET.Configuration"
#define TR98_TT_Configuration_GUI                "InternetGatewayDevice.X_TTNET.Configuration.GUI"
#define TR98_TT_Configuration_GUI_AccessRights                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights"
#define TR98_TT_Configuration_GUI_AccessRights_Page                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Broad                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband"
#ifndef TT_HGW
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_InetDSL                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.Internet_DSL"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_InetWAN                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.Internet_WAN"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTVDSL                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.IPTV_DSL"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTVWAN                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.IPTV_WAN"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_MamgWAN                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.ETHMANAGEMENT_WAN"
#else
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Inet                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.Internet"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Mamg                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.Management"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_VoIP                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.VoIP"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTV                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.IPTV"
#endif
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_ACSDSL                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.ACS_DSL"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_ACSWAN                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.ACS_WAN"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Advanced                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Broadband.Broadband.Advanced"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Wireless"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_General                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Wireless.General"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_MoreAP                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Wireless.MoreAP"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_WPS               "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Wireless.WPS"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_WMM                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Wireless.WMM"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_Others                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Wireless.Others"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNetworking                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.HomeNetworking"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNking_LANSetup                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.HomeNetworking.LANSetup"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNking_LANVLAN                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.HomeNetworking.LANVLAN"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Routing                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.Routing"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_NAT                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.NAT"
#define TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_NAT_ALG                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.NetworkSetting.NAT.ALG"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Security                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Security"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Security_Firewall                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Security.Firewall"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Security_Firewall_DoS                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Security.Firewall.DoS"
#define TR98_TT_Configuration_GUI_AccessRights_Page_SystemMonitor                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.SystemMonitor"
#define TR98_TT_Configuration_GUI_AccessRights_Page_SystemMonitor_Log                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.SystemMonitor.Log"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Maintenance"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_RemoteMGMT                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Maintenance.RemoteMGMT"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_TR069                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Maintenance.TR069"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_Time                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Maintenance.Time"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_LogSetting                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Maintenance.LogSetting"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_FirmwareUpgrade                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Maintenance.FirmwareUpgrade"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_Configuration                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Maintenance.Configuration"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_EDNS                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Maintenance.EDNS"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Engdebug                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Engdebug"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Capture                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Capture"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Easymenu"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu_EM_RemoteAccess                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Easymenu.EM_RemoteAccess"
#define TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu_EM_LocalAccess                "InternetGatewayDevice.X_TTNET.Configuration.GUI.AccessRights.Page.Easymenu.EM_LocalAccess"
#define TR98_TT_Configuration_Shell                "InternetGatewayDevice.X_TTNET.Configuration.Shell"
#define TR98_TT_Configuration_QuickWanBridge                "InternetGatewayDevice.X_TTNET.Configuration.QuickWANBridge"
#define TR98_TT_CFG_QUICK_ATA_BR "InternetGatewayDevice.X_TTNET.Configuration.QuickATABridge"
#ifdef TT_HGW
#define TR98_TT_Configuration_SIP               "InternetGatewayDevice.X_TTNET.Configuration.SIP"
#define TR98_TT_Configuration_DnsSrv               "InternetGatewayDevice.X_TTNET.Configuration.SIP.DNS-SRV"
#endif
#elif defined(TT_CUSTOMIZATION_V6_TTNET)
#define TR98_TT                "InternetGatewayDevice.X_TTNET"
#define TR98_TT_Configuration  "InternetGatewayDevice.X_TTNET.Configuration"
#endif
...
#ifdef ACEN_CUSTOMIZATION
#define TR98_WLANCONFIG                 "InternetGatewayDevice.X_CUSTOM_WLANConfiguration.i"
#define TR98_ACCOUNT_RESETPASSWD             "InternetGatewayDevice.User.i"
#define TR98_AIRTIMEFAIRNESS                 "InternetGatewayDevice.X_CUSTOM_AirtimeFairness"
#endif //ACEN_CUSTOMIZATION
...
#define TR98_RUNNING_WAN_CONN         "InternetGatewayDevice.X_CUSTOM_ActiveWANDevice.i"
#endif
...
#ifdef CONFIG_ZCFG_BE_MODULE_ZYXEL_FSECURE
#define TR98_FSECURE             "InternetGatewayDevice.X_ZYXEL_FSecure"
#endif
...
{TR98_USR_INTF,                 0,              para_UsrIntf,     usrIntfObjGet,           usrIntfObjSet,          NULL,             NULL,            usrIntfObjNotify, usrIntfObjAttrGet, usrIntfObjAttrSet},
...
#if defined(L3IPV6FWD) && !defined(CONFIG_TT_CUSTOMIZATION_TR069)
...
#ifdef TT_CUSTOMIZATION_V6
// TTG, TTNET
{TR98_LAN_DEV_TT_V6_HOST_CFG_MGMT, 0, para_LanIPv6HostCfgMgmt, lanV6HostCfgMgmtGet, lanV6HostCfgMgmtSet, NULL, NULL, NULL, NULL, NULL},
#endif
...
#endif
#ifdef ZYXEL_TTNET_TR69ALG////MSTC_TTALG, RichardFeng
{TR98_TT_H323Alg,             	0,				para_H323Alg,        			zyTTH323AlgObjGet,        			 zyTTH323AlgObjSet,       			 NULL,	NULL,	zyTTH323AlgObjNotify,	zyTTH323AlgObjAttrGet,	zyTTH323AlgObjAttrSet},
{TR98_TT_SIPAlg,				0,				para_SIPAlg,					zyTTSIPAlgObjGet,					 zyTTSIPAlgObjSet, 				 NULL,	NULL,	zyTTSIPAlgObjNotify,	zyTTSIPAlgObjAttrGet,	zyTTSIPAlgObjAttrSet},
{TR98_TT_RTSPAlg,             	0,				para_RTSPAlg,        			zyTTRTSPAlgObjGet,        			 zyTTRTSPAlgObjSet,       			 NULL,	NULL,	zyTTRTSPAlgObjNotify,	zyTTRTSPAlgObjAttrGet,	zyTTRTSPAlgObjAttrSet},
{TR98_TT_PPTPAlg,             	0,				para_PPTPAlg,        			zyTTPPTPAlgObjGet,        			 zyTTPPTPAlgObjSet,       			 NULL,	NULL,	zyTTPPTPAlgObjNotify,	zyTTPPTPAlgObjAttrGet,	zyTTPPTPAlgObjAttrSet},
{TR98_TT_IPSecAlg,             	0,				para_IPSecAlg,        			zyTTIPSecAlgObjGet,        			 zyTTIPSecAlgObjSet,       			 NULL,	NULL,	zyTTIPSecAlgObjNotify,	zyTTIPSecAlgObjAttrGet,	zyTTIPSecAlgObjAttrSet},
{TR98_TT_L2TPAlg,             	0,				para_L2TPAlg,        			zyTTL2TPAlgObjGet,        			 zyTTL2TPAlgObjSet,       			 NULL,	NULL,	zyTTL2TPAlgObjNotify,	zyTTL2TPAlgObjAttrGet,	zyTTL2TPAlgObjAttrSet},
{TR98_TT_IGMPProxy,				0,				para_IGMPProxy,					zyTTIGMPProxyObjGet,					 zyTTIGMPProxyObjSet, 				 NULL,	NULL,	zyTTIGMPProxyObjNotify,	zyTTIGMPProxyObjAttrGet,	zyTTIGMPProxyObjAttrSet},
{TR98_TT_SMTP,             		0,				para_SMTP,        				zyTTSMTPObjGet,        			 zyTTSMTPObjSet,       			 NULL,	NULL,	zyTTSMTPObjNotify,	zyTTSMTPObjAttrGet,	zyTTSMTPObjAttrSet},
{TR98_TT_ICMP,					0,				para_ICMP,						zyTTICMPObjGet, 				 zyTTICMPObjSet,				 NULL,	NULL,	zyTTICMPObjNotify,	zyTTICMPObjAttrGet, zyTTICMPObjAttrSet},
{TR98_TT_NTP,					0,				para_NTP,						zyTTNTPObjGet, 				 zyTTNTPObjSet,				 NULL,	NULL,	zyTTNTPObjNotify,	zyTTNTPObjAttrGet, zyTTNTPObjAttrSet},
#endif
#ifdef ZYXEL_TTNET_EDNS//Add ppp username to edns option for TT
{TR98_TT_EDNS,             		0,				para_EDNS,        				zyTTEDNSObjGet,        			 zyTTEDNSObjSet,       			 NULL,	NULL,	zyTTEDNSObjNotify,	zyTTEDNSObjAttrGet,	zyTTEDNSObjAttrSet},
#endif
#if (defined(CONFIG_TT_PORTMIRROR) || defined(CONFIG_TT_PORTMIRROR_E))
{TR98_TT_PORTMIRROR, 		0,				para_TTPORTMIRROR,					zyTTPORTMIRRORObjGet,					 zyTTPORTMIRRORObjSet,					 NULL,	NULL,	zyTTPORTMIRRORObjNotify, zyTTPORTMIRRORObjAttrGet,	zyTTPORTMIRRORObjAttrSet},
#endif
#ifdef CONFIG_ZCFG_BE_MODULE_PKT_CAPTURE
{TR98_TT_PACKETCAPTURE, 		0,				para_TTPACKETCAPTURE,					zyTTPACKETCAPTUREObjGet,					 zyTTPACKETCAPTUREObjSet,					 NULL,	NULL,	zyTTPACKETCAPTUREObjNotify, zyTTPACKETCAPTUREObjAttrGet,	zyTTPACKETCAPTUREObjAttrSet},
{TR98_TT_PACKETCAPTUREUPLOAD, 		0,				para_TTPACKETCAPTUREUPLOAD,					zyTTPACKETCAPTUREUPLOADObjGet,					 zyTTPACKETCAPTUREUPLOADObjSet,					 NULL,	NULL,	zyTTPACKETCAPTUREUPLOADObjNotify, zyTTPACKETCAPTUREUPLOADObjAttrGet,	zyTTPACKETCAPTUREUPLOADObjAttrSet},
#endif
#ifdef TT_HGW
{TR98_TT_CWMP, 		0,				para_TTCWMP,					zyTTCWMPObjGet,					 zyTTCWMPObjSet,					 NULL,	NULL,	zyTTCWMPObjNotify, zyTTCWMPObjAttrGet,	zyTTCWMPObjAttrSet},
#endif
#if ZYXEL_EXT
...
#ifdef ACEN_CUSTOMIZATION
{TR98_ACEN_EXT,             	0,				NULL,        			NULL,        			 NULL,       			 NULL,	NULL,	NULL,	NULL,	NULL},
#endif //ACEN_CUSTOMIZATION
...
#ifdef ACEN_CUSTOMIZATION
#ifdef CONFIG_ZCFG_BE_MODULE_WIFI
{TR98_WLANCONFIG, ATTR_INDEX_CREA, 	para_WLANConfiguration,	zyExtWLANConfigurationObjGet,	NULL, NULL, NULL, NULL},
...
#endif
#ifdef CONFIG_ZCFG_BE_MODULE_ZYXEL_FSECURE
{TR98_FSECURE,		0,		para_Fsecure,		zyExtFsecureObjGet,		zyExtFsecureObjSet,		NULL,		NULL,		NULL,		NULL,		NULL},
#endif
#ifdef CONFIG_ZCFG_BE_MODULE_IPK_PACKAGE
...
#endif
#ifdef ZYXEL_EASYMESH_R2
{TR98_EasyMeshTs,     0, para_EasyMeshTs,     zyExtEasyMeshTsObjGet, zyExtEasyMeshTsObjSet, NULL, NULL, NULL, NULL, NULL},
#endif
...
#endif
#ifdef CONFIG_ZCFG_BE_MODULE_TWAMP
{TR98_TWAMPD,					0,				para_Twampd,			zyExtTwampdObjGet,				zyExtTwampdObjSet,			NULL,			NULL,		NULL,	NULL,	NULL},
#endif
#ifdef ZYXEL_WIFI_HW_BUTTON_SWITCH
{TR98_TT_Configuration_Button,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_Button_WiFi,				0,				para_HwWiFiButton,					zyExtHwWiFiButtonObjGet, 				 zyExtHwWiFiButtonObjSet,				 NULL,	NULL,	zyExtHwWiFiButtonObjNotify,	zyExtHwWiFiButtonObjAttrGet, zyExtHwWiFiButtonObjAttrSet},
#endif
#ifdef CONFIG_ZCFG_BE_MODULE_ZYXEL_QUANTWIFI
{TR98_TT_Configuration_Quantwifi,				0,				para_Quantwifi,					zyExtQuantwifiObjGet, 				 zyExtQuantwifiObjSet,				 NULL,	NULL,	zyExtQuantwifiObjNotify,	zyExtQuantwifiObjAttrGet, zyExtQuantwifiObjAttrSet},
#endif
#ifdef ZYXEL_XMPP
/* TR98 Full Path Name          Attribute       Parameter List          Get func                 Set func                Add func          Del func         Notify func Get Attr func       Set Attr func*/
...
#endif
#if defined(ZYXEL_IGMPDIAG) || defined(ZYXEL_CUSTOMIZATION_SYSLOG)
{TR98_TT_Function, 			0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
#endif
#ifdef ZYXEL_IGMPDIAG
...
#endif
#ifdef ZYXEL_TT_WAN_CONN_DIAG
{TR98_TT_WanConnDiagnostics,             	0,				para_TTWanConnDiagnostics,        			zyTTWanConnDiagObjGet,        			 zyTTWanConnDiagObjSet,       			 NULL,	NULL,	zyTTWanConnDiagObjNotify,	zyTTWanConnDiagObjAttrGet,	zyTTWanConnDiagObjAttrSet},
#endif
#ifdef ZYXEL_CUSTOMIZATION_SYSLOG
{TR98_TT_Syslog,             	0,				para_Syslog,        			zyTTSyslogObjGet,        			 zyTTSyslogObjSet,       			 NULL,	NULL,	zyTTSyslogObjNotify,	zyTTSyslogObjAttrGet,	zyTTSyslogObjAttrSet},
{TR98_TT_SyslogUpload,				0,				para_SyslogUpload,					zyTTSyslogUploadObjGet,					 zyTTSyslogUploadObjSet, 				 NULL,	NULL,	zyTTSyslogUploadObjNotify,	zyTTSyslogUploadObjAttrGet,	zyTTSyslogUploadObjAttrSet},
#endif


#ifdef TT_CUSTOMIZATION_V6
#ifndef TT_CUSTOMIZATION_V6_TTNET
{ TR98_TTG, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL},
{ TR98_TTG_CFG, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL},
{ TR98_TTG_CFG_IPV6LAN, 0, para_TTCfgIPV6Lan, ttcfgIpV6LanQuery, ttcfgIpV6LanSet, NULL, NULL, NULL, NULL, NULL},
#else
{ TR98_TT_CFG_IPV6LAN, 0, para_TTCfgIPV6Lan, ttcfgIpV6LanQuery, ttcfgIpV6LanSet, NULL, NULL, NULL, NULL, NULL},
#endif
#endif

#if defined(MSTC_TTNET_MULTI_USER) || defined(MSTC_RETAIL_MULTI_USER) || defined(TENDER_TT_FEATURE)
{TR98_TT,             	0,				NULL,        			NULL,        			 NULL,       			 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Users,				0,				para_Users,					zyTTUsersObjGet,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Users_User,             	ATTR_INDEX_CREA,				para_User,        			zyTTUserObjGet,        			 zyTTUserObjSet,       			 zyTTUserObjAdd,	zyTTUserObjDel,	zyTTUserObjNotify,	zyTTUserObjAttrGet,	zyTTUserObjAttrSet},
{TR98_TT_UserInterface,				0,				para_UserInterface,					zyTTUserInterfaceObjGet, 				 zyTTUserInterfaceObjSet,				 NULL,	NULL,	zyTTUserInterfaceObjNotify,	zyTTUserInterfaceObjAttrGet, zyTTUserInterfaceObjAttrSet},
{TR98_TT_UserInterface_RemoteAccess, 			0,				para_RemoteLocalAccess, 				zyTTRemoteAccessObjGet,				 zyTTRemoteAccessObjSet,				 NULL,	NULL,	zyTTRemoteAccessObjNotify, zyTTRemoteAccessObjAttrGet, zyTTRemoteAccessObjAttrSet},
{TR98_TT_UserInterface_LocalAccess, 			0,				para_RemoteLocalAccess, 				zyTTLocalAccessObjGet,				 zyTTLocalAccessObjSet,				 NULL,	NULL,	zyTTLocalAccessObjNotify, zyTTLocalAccessObjAttrGet, zyTTLocalAccessObjAttrSet},
{TR98_TT_Firewall, 			0,				para_TTFirewall, 				zyTTFirewallObjGet,				 zyTTFirewallObjSet,				 NULL,	NULL,	zyTTFirewallObjNotify, zyTTFirewallObjAttrGet, zyTTFirewallObjAttrSet},
{TR98_TT_UPnP, 			0,				NULL,				NULL,				 NULL,				 NULL,	NULL,	NULL, NULL, NULL},
{TR98_TT_UPnP_Device, 			0,				para_UPnPDevice, 				zyTTUPnPDeviceObjGet,				 zyTTUPnPDeviceObjSet,				 NULL,	NULL,	zyTTUPnPDeviceObjNotify, zyTTUPnPDeviceObjAttrGet, zyTTUPnPDeviceObjAttrSet},
{TR98_TT_Configuration,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Broad, 			0,				para_GUIAccessRights, 				zyTTBroadbandObjGet,				 zyTTBroadbandObjSet,				 NULL,	NULL,	zyTTBroadbandObjNotify, zyTTBroadbandObjAttrGet, zyTTBroadbandObjAttrSet},
#ifndef TT_HGW
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_InetDSL,				0,				para_GUIAccessRights,					zyTTInternetDSLObjGet, 				 zyTTInternetDSLObjSet,				 NULL,	NULL,	zyTTInternetDSLObjNotify,	zyTTInternetDSLObjAttrGet, zyTTInternetDSLObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_InetWAN,				0,				para_GUIAccessRights,					zyTTInternetWANObjGet, 				 zyTTInternetWANObjSet,				 NULL,	NULL,	zyTTInternetWANObjNotify,	zyTTInternetWANObjAttrGet, zyTTInternetWANObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTVDSL,				0,				para_GUIAccessRights,					zyTTIPTVDSLObjGet, 				 zyTTIPTVDSLObjSet,				 NULL,	NULL,	zyTTIPTVDSLObjNotify,	zyTTIPTVDSLObjAttrGet, zyTTIPTVDSLObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTVWAN,				0,				para_GUIAccessRights,					zyTTIPTVWANObjGet, 				 zyTTIPTVWANObjSet,				 NULL,	NULL,	zyTTIPTVWANObjNotify,	zyTTIPTVWANObjAttrGet, zyTTIPTVWANObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_MamgWAN,				0,				para_GUIAccessRights,					zyTTMamgWANObjGet, 				 zyTTMamgWANObjSet,				 NULL,	NULL,	zyTTMamgWANObjNotify,	zyTTMamgWANObjAttrGet, zyTTMamgWANObjAttrSet},
#else
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Inet,				0,				para_GUIAccessRights,					zyTTInetObjGet, 				 zyTTInetObjSet,				 NULL,	NULL,	zyTTInetObjNotify,	zyTTInetObjAttrGet, zyTTInetObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Mamg,				0,				para_GUIAccessRights,					zyTTMamgObjGet, 				 zyTTMamgObjSet,				 NULL,	NULL,	zyTTMamgObjNotify,	zyTTMamgObjAttrGet, zyTTMamgObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_VoIP,				0,				para_GUIAccessRights,					zyTTVoIPObjGet, 				 zyTTVoIPObjSet,				 NULL,	NULL,	zyTTVoIPObjNotify,	zyTTVoIPObjAttrGet, zyTTVoIPObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_IPTV,				0,				para_GUIAccessRights,					zyTTIPTVObjGet, 				 zyTTIPTVObjSet,				 NULL,	NULL,	zyTTIPTVObjNotify,	zyTTIPTVObjAttrGet, zyTTIPTVObjAttrSet},
#endif
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_ACSDSL,				0,				para_GUIAccessRights,					zyTTACSDSLObjGet,				 zyTTACSDSLObjSet, 			 NULL,	NULL,	zyTTACSDSLObjNotify,	zyTTACSDSLObjAttrGet, zyTTACSDSLObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_ACSWAN,				0,				para_GUIAccessRights,					zyTTACSWANObjGet,				 zyTTACSWANObjSet, 			 NULL,	NULL,	zyTTACSWANObjNotify,	zyTTACSWANObjAttrGet, zyTTACSWANObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Broadband_Advanced,				0,				para_GUIAccessRights,					zyTTAdvancedObjGet,				 zyTTAdvancedObjSet, 			 NULL,	NULL,	zyTTAdvancedObjNotify,	zyTTAdvancedObjAttrGet, zyTTAdvancedObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_General,			0,				para_GUIAccessRights,				zyTTGeneralObjGet,				 zyTTGeneralObjSet,				 NULL,	NULL,	zyTTGeneralObjNotify, zyTTGeneralObjAttrGet, zyTTGeneralObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_MoreAP,			0,				para_GUIAccessRights,				zyTTMoreAPObjGet,				 zyTTMoreAPObjSet, 			 NULL,	NULL,	zyTTMoreAPObjNotify, zyTTMoreAPObjAttrGet, zyTTMoreAPObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_WPS,			0,				para_GUIAccessRights,				zyTTWPSObjGet,				 zyTTWPSObjSet, 			 NULL,	NULL,	zyTTWPSObjNotify, zyTTWPSObjAttrGet, zyTTWPSObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_WMM,			0,				para_GUIAccessRights,				zyTTWMMObjGet,				 zyTTWMMObjSet, 			 NULL,	NULL,	zyTTWMMObjNotify, zyTTWMMObjAttrGet, zyTTWMMObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Wireless_Others,			0,				para_GUIAccessRights,				zyTTOthersObjGet,				 zyTTOthersObjSet, 			 NULL,	NULL,	zyTTOthersObjNotify, zyTTOthersObjAttrGet, zyTTOthersObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNetworking,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNking_LANSetup,			0,				para_GUIAccessRights,				zyTTLANSetupObjGet,				 zyTTLANSetupObjSet, 			 NULL,	NULL,	zyTTLANSetupObjNotify, zyTTLANSetupObjAttrGet, zyTTLANSetupObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_HomeNking_LANVLAN, 		0,				para_GUIAccessRights,				zyTTLANVLANObjGet,				 zyTTLANVLANObjSet, 			 NULL,	NULL,	zyTTLANVLANObjNotify, zyTTLANVLANObjAttrGet, zyTTLANVLANObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_Routing, 		0,				para_GUIAccessRights,				zyTTRoutingObjGet, 			 zyTTRoutingObjSet,			 NULL,	NULL,	zyTTRoutingObjNotify, zyTTRoutingObjAttrGet, zyTTRoutingObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_NAT,			0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_NetworkSetting_NAT_ALG, 		0,				para_GUIAccessRights,				zyTTALGObjGet, 			 zyTTALGObjSet,			 NULL,	NULL,	zyTTALGObjNotify, zyTTALGObjAttrGet, zyTTALGObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Security,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_Security_Firewall,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_Security_Firewall_DoS,		0,				para_GUIAccessRights,				zyTTDoSObjGet,			 zyTTDoSObjSet, 		 NULL,	NULL,	zyTTDoSObjNotify, zyTTDoSObjAttrGet, zyTTDoSObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_SystemMonitor,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_SystemMonitor_Log, 	0,				para_GUIAccessRights,				zyTTLogObjGet,			 zyTTLogObjSet, 		 NULL,	NULL,	zyTTLogObjNotify, zyTTLogObjAttrGet, zyTTLogObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_RemoteMGMT, 	0,				para_GUIAccessRights,				zyTTRemoteMGMTObjGet,			 zyTTRemoteMGMTObjSet, 		 NULL,	NULL,	zyTTRemoteMGMTObjNotify, zyTTRemoteMGMTObjAttrGet, zyTTRemoteMGMTObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_TR069, 	0,				para_GUIAccessRights,				zyTTTR069ObjGet,			 zyTTTR069ObjSet, 		 NULL,	NULL,	zyTTTR069ObjNotify, zyTTTR069ObjAttrGet, zyTTTR069ObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_Time, 	0,				para_GUIAccessRights,				zyTTTimeObjGet,			 zyTTTimeObjSet, 		 NULL,	NULL,	zyTTTimeObjNotify, zyTTTimeObjAttrGet, zyTTTimeObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_LogSetting, 	0,				para_GUIAccessRights,				zyTTLogSettingObjGet,			 zyTTLogSettingObjSet, 		 NULL,	NULL,	zyTTLogSettingObjNotify, zyTTLogSettingObjAttrGet, zyTTLogSettingObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_FirmwareUpgrade, 	0,				para_GUIAccessRights,				zyTTFirmwareUpgradeObjGet,			 zyTTFirmwareUpgradeObjSet, 		 NULL,	NULL,	zyTTFirmwareUpgradeObjNotify, zyTTFirmwareUpgradeObjAttrGet, zyTTFirmwareUpgradeObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_Configuration, 	0,				para_GUIAccessRights,				zyTTConfigurationObjGet,			 zyTTConfigurationObjSet, 		 NULL,	NULL,	zyTTConfigurationObjNotify, zyTTConfigurationObjAttrGet, zyTTConfigurationObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Maintenance_EDNS, 	0,				para_GUIAccessRights,				zyTTEDNSPageObjGet,			 zyTTEDNSPageObjSet,		 NULL,	NULL,	zyTTEDNSPageObjNotify, zyTTEDNSPageObjAttrGet, zyTTEDNSPageObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Engdebug, 	0,				para_GUIAccessRights,				zyTTEngdebugObjGet,			 zyTTEngdebugObjSet,		 NULL,	NULL,	zyTTEngdebugObjNotify, zyTTEngdebugObjAttrGet, zyTTEngdebugObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Capture,	0,				para_GUIAccessRights,				zyTTCaptureObjGet,			 zyTTCaptureObjSet,		 NULL,	NULL,	zyTTCaptureObjNotify, zyTTCaptureObjAttrGet, zyTTCaptureObjAttrSet},
{TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu_EM_RemoteAccess,	0,				para_GUIAccessRights,				zyTTEMRemoteAccessObjGet,			 zyTTEMRemoteAccessObjSet,		 NULL,	NULL,	NULL, NULL, NULL},
{TR98_TT_Configuration_GUI_AccessRights_Page_Easymenu_EM_LocalAccess,	0,				para_GUIAccessRights,				zyTTEMLoaclAccessObjGet,			 zyTTEMLoaclAccessObjSet,		 NULL,	NULL,	NULL, NULL, NULL},
{TR98_TT_Configuration_Shell,	0,				para_Shell,				zyTTShellObjGet,			 zyTTShellObjSet, 	 NULL,	NULL,	zyTTShellObjNotify, zyTTShellObjAttrGet, zyTTShellObjAttrSet},
{TR98_TT_Configuration_QuickWanBridge, 0,				para_QuickWanBridge,			zyTTQuickWanBridgeObjGet, zyTTQuickWanBridgeObjSet,  NULL,	NULL,	zyTTQuickWanBridgeObjNotify, zyTTQuickWanBridgeObjAttrGet, zyTTQuickWanBridgeObjAttrSet},
{TR98_TT_CFG_QUICK_ATA_BR, 0, para_TTQBridging, ttcfgQuickBridgingQuery, ttcfgQuickBridgingSet, NULL, NULL, NULL, NULL, NULL},
#ifdef TT_HGW
{TR98_TT_Configuration_SIP,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration_DnsSrv, 0, 			para_DnsSrv,			zyTTDnsSrvObjGet, 		 zyTTDnsSrvObjSet,  NULL, NULL,	zyTTDnsSrvObjNotify, zyTTDnsSrvObjAttrGet, zyTTDnsSrvObjAttrSet},
#endif
#elif defined(TT_CUSTOMIZATION_V6_TTNET)
{TR98_TT,             	0,				NULL,        			NULL,        			 NULL,       			 NULL,	NULL,	NULL,	NULL,	NULL},
{TR98_TT_Configuration,				0,				NULL,					NULL,					 NULL,					 NULL,	NULL,	NULL,	NULL,	NULL},
...
{TR98_ZyEE_SoftwareMoudles_ExecEnv,                                 ATTR_INDEXNODE,            para_ZyeeExecEnv,                           ZyEEObjGet,              ZyEEObjSet,               NULL,      NULL,             NULL,            NULL},
