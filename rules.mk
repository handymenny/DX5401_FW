...
#$(info ==============CONFIG_EXTERNAL_TOOLCHAIN=====>TOOLCHAIN_ROOT_DIR = $(TOOLCHAIN_ROOT_DIR))
export LD_LIBRARY_PATH:=$(TOOLCHAIN_ROOT_DIR)/lib:$(LD_LIBRARY_PATH)
endif
...
ifndef DUMP
  ...
  ifeq ($(CONFIG_EXTERNAL_TOOLCHAIN),)
  CHECKSSP_TOOLCHAIN_DIR=$(TOPDIR)/staging_dir/toolchain-$(ARCH)$(ARCH_SUFFIX)_gcc-$(GCCV)$(DIR_SUFFIX)
  ...
  ifeq (_$(CONFIG_EXTERNAL_KERNEL_TOOLCHAIN)_$(FORCE_USE_EXTERNAL_KERNAL_TOOLCHAIN)_,_y_y_)
    ...
    TARGET_PATH:=$(KERNEL_TOOLCHAIN_DIR)/bin:$(TARGET_PATH)
      ...
      ifneq ($(CONFIG_TOOLCHAIN_ROOT_PREFIX),)
        TOOLCHAIN_ROOT_DIR:=$(TOPDIR)/$(call qstrip,$(CONFIG_TOOLCHAIN_ROOT_PREFIX))$(call qstrip,$(CONFIG_TOOLCHAIN_ROOT))
      else
        TOOLCHAIN_ROOT_DIR:=$(call qstrip,$(CONFIG_TOOLCHAIN_ROOT))
      endif
      ...
      CHECKSSP_TOOLCHAIN_DIR=$(TOOLCHAIN_ROOT_DIR)
